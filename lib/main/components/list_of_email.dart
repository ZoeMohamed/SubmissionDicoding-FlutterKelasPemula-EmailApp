...
class ListOfEmails extends StatefulWidget {
  ...
  const ListOfEmails({Key? key, required this.onEmailSelected})
      : super(key: key);
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          const SizedBox(
                              width: 5), // Space between text and dropdown
                      ...
                      press: () {
                        if (Responsive.isMobile(context)) {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder: (context) =>
                                  EmailScreen(email: _filteredEmails[index]),
                            ),
                          );
                        } else {
                          setState(() {
                          ...
                          widget.onEmailSelected(_filteredEmails[
                              index]); 
                        }
                      },
                    ),
